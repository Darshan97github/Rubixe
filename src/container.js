        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <Link to='/' style={{display: 'inline-flex', paddingLeft:'400px'}}> Home </Link> 
            ...
            <img src={logo2} style={{ width: 600, height: 300, float:'left',marginLeft: 850, objectFit: 'cover', display:'inline' }} class="img-thumbnail" alt="..."></img>
            </div>
